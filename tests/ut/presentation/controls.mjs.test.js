...
describe('Presentation controls ES module (unit)', () => {
  test('modules/presentation/controls.mjs exports createSimpleOrbitControls', () => {
    const filepath = path.resolve(__dirname, '../../../modules/presentation/controls.mjs');
    ...
    expect(keys).toEqual(expect.arrayContaining(['createSimpleOrbitControls']));
  });
});
