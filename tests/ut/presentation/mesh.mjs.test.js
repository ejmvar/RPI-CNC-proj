...
describe('Presentation mesh ES module (unit)', () => {
  test('modules/presentation/mesh.mjs exports renderProbePoints and renderMeshOverlay', () => {
    ...
    expect(keys).toEqual(expect.arrayContaining(['renderProbePoints','renderMeshOverlay']));
  });
});
